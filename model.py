...
class HangmanModel:
    def __init__(self, answer: str, lives: int) -> None:
        ...
        self._original = answer  # keep original casing for final reveal
    ...
    def answer(self) -> str | None:
        return self._original if self._game_over else None
    ...
    def did_player_win(self) -> bool:
        return self._game_over and self._player_won

    @property
    def did_player_lose(self) -> bool:
        return self._game_over and not self._player_won
